...
def parse_args():
    ...
    parser.add_argument('--logdir', type=str, help='directory to save log/data files', default='logs')
    ...
    parser.add_argument('--prior_dataset', type=str, help='prior dataset to fit initial model to', default='logs/calibration_dataset*.pk')
